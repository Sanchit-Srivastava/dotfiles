...
vim.api.nvim_set_keymap("n", "<leader>fz", "<cmd>Telescope bibtex<CR>", { noremap = true, silent = true }) --telescope citations

vim.keymap.set("n", "<leader>zz", function()
	require("nabla").popup() -- Change "rounded" to "single" or "double" if preferred
end, { desc = "Show Nabla popup with border" })
